	...
	function add_scripts(){
		...
		if ( !is_admin() ) {
		   wp_enqueue_script('jquery');
            ...
            wp_register_script('bxslider', get_stylesheet_directory_uri().'/js/bxslider/jquery.bxslider.min.js', array('jquery','site_js'));
            wp_enqueue_script('bxslider');
            wp_register_style('font_awesome', get_stylesheet_directory_uri().'/css/font-awesome.css');
